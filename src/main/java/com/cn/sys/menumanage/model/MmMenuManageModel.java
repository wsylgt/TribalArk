 ...
 */
public class MmMenuManageModel implements Serializable {
     ...
     * 菜单对应的资源
     */
    private MmResourcesModel resourcesModel;

    /**
     * 菜单对应的资源取得
     * @return 资源
     */
    public MmResourcesModel getResourcesModel() {
        return resourcesModel;
    }

    /**
     * 菜单对应的资源的设定
     * @param resourcesModel 资源
     */
    public void setResourcesModel(MmResourcesModel resourcesModel) {
