...
<%@attribute name="setStorehouseAddressControlId" required="false" type="java.lang.String" %>
...
<input type="hidden" id="setStorehouseAddressControlId" value="${setStorehouseAddressControlId}"/>
...
<script src="${storehouseModalBasePath}/resource/js/sm/storehousemanage/storehouse-select.js"></script>
