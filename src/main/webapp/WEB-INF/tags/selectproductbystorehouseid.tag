<%--
  DESCRIBE: 货品信息选择[设置警戒/标准库存]模态框画面
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row" style="margin-bottom: -10px;">
                            ...
                            <div class="col-lg-2">
                                <button type="button" class="btn btn-primary btn-sm" id="btnSearchProductByStorehouseId" tabindex="220">查询</button>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive" style="max-height:400px; overflow-y:auto;">
                            <table Id="productInfoTable" class="table table-bordered table-condensed table-striped-extension table-hover-extension">
                                <thead>
                                    <tr class="emall">
                    ...
                    <div class="panel-footer">
                        ...
                        <button id="btnSelectProductModalByStorehouseId" type="button" class="btn btn-primary btn-sm" data-dismiss="modal">&nbsp;&nbsp;确定&nbsp;&nbsp;</button>
...
<script src="${productModalBasePath}/resource/js/gm/product/select-product-by-storehouse-id.js"></script>
