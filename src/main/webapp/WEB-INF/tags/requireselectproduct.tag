<%--
  DESCRIBE: 货品信息选择列表模态框画面（新建采购需求单用）

  Copyright 2016-2016
  VERSION : 1.0
  DATE    : 2016/07/19
  AUTHOR  : 祝盼
  HISTORY : 2016/07/19 begin
--%>
...
<div class="modal fade" id="requireSelectProductModal" tabindex="-1" role="dialog" aria-labelledby="requireSelectProductModalLabel">
  <div class="modal-dialog" role="document" style="width: 70%;">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="requireSelectProductModalLabel">选择货品</h4>
      </div>
...
<script src="${productModalBasePath}/resource/js/pur/purrequireorder/require-select-product.js"></script>
